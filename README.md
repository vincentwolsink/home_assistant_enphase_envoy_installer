...
- Service call to enable/disable DPEL.
...
|Envoy xxx DPEL|switch.envoy_xxx_dpel_enabled|On / Off|
|Envoy xxx DPEL Limit|number.envoy_xxx_dpel_limit|W|
|Envoy xxx DPEL Mode|select.envoy_xxx_dpel_mode|Production / Export|
...
|Envoy xxx Lifetime Batteries Energy Charged L3|sensor.envoy_xxx_lifetime_batteries_charged_l3|Wh|
...
ℹ️ This integration replaces the Home Assistant built-in Enphase integration. Please remove any current Enphase configuration before installing this one. (You won't lose sensor history/statistics if you make sure the sensor names are matching.)
